...
class SWAP:
    ...
    visualize = False
    img_path = '/home/viraj-uk/HUSTLE/FACE_SWAPPING/images/write/7'
    ...
    def __init__(self, img1, img2):
        ...
        self.img2_copy_copy = self.img2.copy()
    ...
    def my(self):
        ...
        for key in self.ordered_triangles:
            ...
            cv2.line(self.img1_copy, self.landmarks_points.first[pt1], self.landmarks_points.first[pt2], color, 2)
            cv2.line(self.img1_copy, self.landmarks_points.first[pt2], self.landmarks_points.first[pt3], color, 2)
            cv2.line(self.img1_copy, self.landmarks_points.first[pt3], self.landmarks_points.first[pt1], color, 2)
            ...
            cv2.line(self.img2_copy_copy, self.landmarks_points.second[pt1], self.landmarks_points.second[pt2], color, 2)
            cv2.line(self.img2_copy_copy, self.landmarks_points.second[pt2], self.landmarks_points.second[pt3], color, 2)
            cv2.line(self.img2_copy_copy, self.landmarks_points.second[pt3], self.landmarks_points.second[pt1], color, 2)
            ...
            row_1 = [self.img1_copy, self.img2_copy_copy]
        ...
        #
        # row_1 = [self.img1_copy, self.img2_copy_copy, mixed_clone]
        #
        # stacked_image = self.imgStack.stack_images(0.5, (row_1))
        # cv2.imwrite(os.path.join(self.img_path, 'result.jpg'), stacked_image)
        # cv2.imshow('Stacked Image', stacked_image)
